...
const TRANSLATIONS = {
  en: {
    nav_home: 'Home', nav_freeplay: 'Quick match', nav_competition: 'League', nav_tournament: 'Tournament', nav_stats: 'Leaderboard', nav_settings: 'Settings',
    ...
    group_events_title: 'Club events',
    ...
    group_request_sent: 'Request sent', group_pending_requests_title: 'Join requests', btn_approve: 'Approve', group_remove_member: 'Remove', groups_nearby_title: 'Nearby clubs',
    group_edit_button: 'Edit club', group_save_button: 'Save', group_delete_button: 'Delete club', group_last_admin_warning: "You're the only admin \u2014 promote another member to admin first, or the club will be left without one.", group_promote_button: 'Make admin',
    group_invite_section_title: 'Invite someone', group_invites_title: 'Club invitations',
    event_name_placeholder: 'Event name', event_link_group_label: 'Link to a club (optional)', event_no_group_option: 'No club', event_create_button: 'Create event', event_code_label: 'Join code', event_share_hint: 'Share this code so others can join', event_participants_title: 'Participants', event_close_registration: 'Close registration', event_status_open: 'Registration open', event_status_closed: 'Registration closed', event_join_button: 'Join event', event_join_code_placeholder: 'Enter join code', event_join_via_code_title: 'Have a code?', event_leave_button: 'Leave event', event_not_found: 'No event found with that code.', event_already_joined: 'Joined',
    ...
    player_groups_title: 'Groups', player_completed_challenges_title: 'Completed challenges',
  ...
  fr: {
    nav_home: 'Accueil', nav_freeplay: 'Match rapide', nav_competition: 'Ligue', nav_tournament: 'Tournoi', nav_stats: 'Classement', nav_settings: 'Réglages',
    ...
    group_events_title: 'Événements du club',
    ...
    group_request_sent: 'Demande envoyée', group_pending_requests_title: "Demandes d'adhésion", btn_approve: 'Approuver', group_remove_member: 'Retirer', groups_nearby_title: 'Clubs à proximité',
    group_edit_button: 'Modifier le club', group_save_button: 'Enregistrer', group_delete_button: 'Supprimer le club', group_last_admin_warning: "Vous êtes le seul admin \u2014 promouvez d'abord un autre membre, sinon le club restera sans admin.", group_promote_button: 'Nommer admin',
    group_invite_section_title: 'Inviter quelqu\u2019un', group_invites_title: 'Invitations de club',
    event_name_placeholder: "Nom de l'événement", event_link_group_label: 'Lier à un club (facultatif)', event_no_group_option: 'Aucun club', event_create_button: 'Créer un événement', event_code_label: 'Code de participation', event_share_hint: 'Partagez ce code pour que d\u2019autres puissent rejoindre', event_participants_title: 'Participants', event_close_registration: 'Clôturer les inscriptions', event_status_open: 'Inscriptions ouvertes', event_status_closed: 'Inscriptions clôturées', event_join_button: "Rejoindre l'événement", event_join_code_placeholder: 'Entrez le code', event_join_via_code_title: 'Vous avez un code\u00A0?', event_leave_button: "Quitter l'événement", event_not_found: 'Aucun événement trouvé avec ce code.', event_already_joined: 'Inscrit',
    ...
    player_groups_title: 'Groupes', player_completed_challenges_title: 'Défis réussis',
  ...
  nl: {
    nav_home: 'Home', nav_freeplay: 'Snelle wedstrijd', nav_competition: 'Liga', nav_tournament: 'Toernooi', nav_stats: 'Ranglijst', nav_settings: 'Instelling',
    ...
    group_events_title: 'Clubevenementen',
    ...
    group_request_sent: 'Aanvraag verstuurd', group_pending_requests_title: 'Aanvragen', btn_approve: 'Goedkeuren', group_remove_member: 'Verwijderen', groups_nearby_title: 'Clubs in de buurt',
    group_edit_button: 'Club bewerken', group_save_button: 'Opslaan', group_delete_button: 'Club verwijderen', group_last_admin_warning: 'Je bent de enige admin \u2014 promoot eerst een ander lid tot admin, anders blijft de club zonder admin achter.', group_promote_button: 'Admin maken',
    group_invite_section_title: 'Nodig iemand uit', group_invites_title: 'Clubuitnodigingen',
    event_name_placeholder: 'Naam van het evenement', event_link_group_label: 'Koppel aan een club (optioneel)', event_no_group_option: 'Geen club', event_create_button: 'Evenement aanmaken', event_code_label: 'Deelcode', event_share_hint: 'Deel deze code zodat anderen kunnen aansluiten', event_participants_title: 'Deelnemers', event_close_registration: 'Inschrijvingen sluiten', event_status_open: 'Inschrijvingen open', event_status_closed: 'Inschrijvingen gesloten', event_join_button: 'Evenement joinen', event_join_code_placeholder: 'Voer deelcode in', event_join_via_code_title: 'Heb je een code?', event_leave_button: 'Evenement verlaten', event_not_found: 'Geen evenement gevonden met die code.', event_already_joined: 'Aangesloten',
    ...
    player_groups_title: 'Groepen', player_completed_challenges_title: 'Voltooide challenges',
  ...
  ru: {
    nav_home: 'Главная', nav_freeplay: 'Быстрый матч', nav_competition: 'Лига', nav_tournament: 'Турнир', nav_stats: 'Рейтинг', nav_settings: 'Настройки',
    ...
    group_events_title: 'События клуба',
    ...
    group_request_sent: 'Заявка отправлена', group_pending_requests_title: 'Заявки на вступление', btn_approve: 'Одобрить', group_remove_member: 'Удалить', groups_nearby_title: 'Клубы поблизости',
    group_edit_button: 'Редактировать клуб', group_save_button: 'Сохранить', group_delete_button: 'Удалить клуб', group_last_admin_warning: 'Вы единственный админ \u2014 сначала назначьте другого админа, иначе клуб останется без админа.', group_promote_button: 'Назначить админом',
    group_invite_section_title: 'Пригласить кого-то', group_invites_title: 'Приглашения в клубы',
    event_name_placeholder: 'Название мероприятия', event_link_group_label: 'Привязать к клубу (необязательно)', event_no_group_option: 'Без клуба', event_create_button: 'Создать мероприятие', event_code_label: 'Код для участия', event_share_hint: 'Поделитесь этим кодом, чтобы другие могли присоединиться', event_participants_title: 'Участники', event_close_registration: 'Закрыть регистрацию', event_status_open: 'Регистрация открыта', event_status_closed: 'Регистрация закрыта', event_join_button: 'Присоединиться', event_join_code_placeholder: 'Введите код', event_join_via_code_title: 'Есть код?', event_leave_button: 'Покинуть мероприятие', event_not_found: 'Мероприятие с таким кодом не найдено.', event_already_joined: 'Участвуете',
    ...
    player_groups_title: 'Группы', player_completed_challenges_title: 'Выполненные испытания',
  ...
  zh: {
    nav_home: '首页', nav_freeplay: '快速比赛', nav_competition: '联赛', nav_tournament: '锦标赛', nav_stats: '排行榜', nav_settings: '设置',
    ...
    group_request_sent: '请求已发送', group_pending_requests_title: '加入请求', btn_approve: '批准', group_remove_member: '移除', groups_nearby_title: '附近的俱乐部',
    group_edit_button: '编辑俱乐部', group_save_button: '保存', group_delete_button: '删除俱乐部', group_last_admin_warning: '你是唯一的管理员——请先将另一位成员设为管理员，否则俱乐部将无人管理。', group_promote_button: '设为管理员',
    group_invite_section_title: '邀请某人', group_invites_title: '俱乐部邀请',
    event_name_placeholder: '活动名称', event_link_group_label: '关联俱乐部（可选）', event_no_group_option: '无俱乐部', event_create_button: '创建活动', event_code_label: '加入码', event_share_hint: '分享此代码以便他人加入', event_participants_title: '参与者', event_close_registration: '关闭报名', event_status_open: '报名开放中', event_status_closed: '报名已关闭', event_join_button: '加入活动', event_join_code_placeholder: '输入加入码', event_join_via_code_title: '有邀请码吗？', event_leave_button: '退出活动', event_not_found: '未找到该代码对应的活动。', event_already_joined: '已加入',
    ...
    player_groups_title: '群组', player_completed_challenges_title: '已完成的挑战',
  ...
  es: {
    nav_home: 'Inicio', nav_freeplay: 'Partido rápido', nav_competition: 'Liga', nav_tournament: 'Torneo', nav_stats: 'Clasificación', nav_settings: 'Ajustes',
    ...
    group_events_title: 'Eventos del club',
    ...
    group_request_sent: 'Solicitud enviada', group_pending_requests_title: 'Solicitudes de ingreso', btn_approve: 'Aprobar', group_remove_member: 'Eliminar', groups_nearby_title: 'Clubes cercanos',
    group_edit_button: 'Editar club', group_save_button: 'Guardar', group_delete_button: 'Eliminar club', group_last_admin_warning: 'Eres el único administrador \u2014 asciende primero a otro miembro, o el club se quedará sin administrador.', group_promote_button: 'Hacer administrador',
    group_invite_section_title: 'Invitar a alguien', group_invites_title: 'Invitaciones a clubes',
    event_name_placeholder: 'Nombre del evento', event_link_group_label: 'Vincular a un club (opcional)', event_no_group_option: 'Sin club', event_create_button: 'Crear evento', event_code_label: 'Código de acceso', event_share_hint: 'Comparte este código para que otros puedan unirse', event_participants_title: 'Participantes', event_close_registration: 'Cerrar inscripciones', event_status_open: 'Inscripciones abiertas', event_status_closed: 'Inscripciones cerradas', event_join_button: 'Unirse al evento', event_join_code_placeholder: 'Introduce el código', event_join_via_code_title: '¿Tienes un código?', event_leave_button: 'Abandonar evento', event_not_found: 'No se encontró ningún evento con ese código.', event_already_joined: 'Inscrito',
    ...
    player_groups_title: 'Grupos', player_completed_challenges_title: 'Retos completados',
  ...
  pt: {
    nav_home: 'Início', nav_freeplay: 'Partida rápida', nav_competition: 'Liga', nav_tournament: 'Torneio', nav_stats: 'Classificação', nav_settings: 'Definições',
    ...
    group_events_title: 'Eventos do clube',
    ...
    group_request_sent: 'Pedido enviado', group_pending_requests_title: 'Pedidos de adesão', btn_approve: 'Aprovar', group_remove_member: 'Remover', groups_nearby_title: 'Clubes próximos',
    group_edit_button: 'Editar clube', group_save_button: 'Guardar', group_delete_button: 'Eliminar clube', group_last_admin_warning: 'És o único administrador \u2014 promove primeiro outro membro, ou o clube ficará sem administrador.', group_promote_button: 'Tornar administrador',
    group_invite_section_title: 'Convidar alguém', group_invites_title: 'Convites de clube',
    event_name_placeholder: 'Nome do evento', event_link_group_label: 'Associar a um clube (opcional)', event_no_group_option: 'Sem clube', event_create_button: 'Criar evento', event_code_label: 'Código de acesso', event_share_hint: 'Partilha este código para que outros possam aderir', event_participants_title: 'Participantes', event_close_registration: 'Encerrar inscrições', event_status_open: 'Inscrições abertas', event_status_closed: 'Inscrições encerradas', event_join_button: 'Aderir ao evento', event_join_code_placeholder: 'Introduz o código', event_join_via_code_title: 'Tens um código?', event_leave_button: 'Sair do evento', event_not_found: 'Nenhum evento encontrado com esse código.', event_already_joined: 'Inscrito',
    ...
    player_groups_title: 'Grupos', player_completed_challenges_title: 'Desafios concluídos',
  ...
  ja: {
    nav_home: 'ホーム', nav_freeplay: 'クイックマッチ', nav_competition: 'リーグ戦', nav_tournament: 'トーナメント', nav_stats: 'ランキング', nav_settings: '設定',
    ...
    group_request_sent: '申請を送信しました', group_pending_requests_title: '参加リクエスト', btn_approve: '承認', group_remove_member: '削除', groups_nearby_title: '近くのクラブ',
    group_edit_button: 'クラブを編集', group_save_button: '保存', group_delete_button: 'クラブを削除', group_last_admin_warning: 'あなたは唱一の管理者です — 先に他のメンバーを管理者にしてください。さもないとクラブに管理者がいなくなります。', group_promote_button: '管理者にする',
    group_invite_section_title: '誰かを招待', group_invites_title: 'クラブ招待',
    event_name_placeholder: 'イベント名', event_link_group_label: 'クラブに紐付け（任意）', event_no_group_option: 'クラブなし', event_create_button: 'イベントを作成', event_code_label: '参加コード', event_share_hint: 'このコードを共有すると参加できます', event_participants_title: '参加者', event_close_registration: '参加受付を締め切る', event_status_open: '参加受付中', event_status_closed: '参加受付終了', event_join_button: 'イベントに参加', event_join_code_placeholder: 'コードを入力', event_join_via_code_title: 'コードをお持ちですか？', event_leave_button: 'イベントを退出', event_not_found: 'そのコードのイベントが見つかりません。', event_already_joined: '参加済み',
    ...
    player_groups_title: 'グループ', player_completed_challenges_title: '完了したチャレンジ',
  ...
  ko: {
    nav_home: '홈', nav_freeplay: '빠른 경기', nav_competition: '리그', nav_tournament: '토너먼트', nav_stats: '순위', nav_settings: '설정',
    ...
    group_request_sent: '요청을 보냈습니다', group_pending_requests_title: '가입 요청', btn_approve: '승인', group_remove_member: '삭제', groups_nearby_title: '주변 클럽',
    group_edit_button: '클럽 편집', group_save_button: '저장', group_delete_button: '클럽 삭제', group_last_admin_warning: '당신이 유일한 관리자입니다 — 먼저 다른 멤버를 관리자로 지정하세요. 그렇지 않으면 클럽에 관리자가 없게 됩니다.', group_promote_button: '관리자로 지정',
    group_invite_section_title: '누군가 초대하기', group_invites_title: '클럽 초대',
    event_name_placeholder: '이벤트 이름', event_link_group_label: '클럽에 연결 (선택 사항)', event_no_group_option: '클럽 없음', event_create_button: '이벤트 만들기', event_code_label: '참가 코드', event_share_hint: '이 코드를 공유하면 다른 사람이 참여할 수 있습니다', event_participants_title: '참가자', event_close_registration: '등록 마감', event_status_open: '등록 진행 중', event_status_closed: '등록 마감됨', event_join_button: '이벤트 참가', event_join_code_placeholder: '코드 입력', event_join_via_code_title: '코드가 있으신가요?', event_leave_button: '이벤트 나가기', event_not_found: '해당 코드로 이벤트를 찾을 수 없습니다.', event_already_joined: '참가함',
    ...
    player_groups_title: '그룹', player_completed_challenges_title: '완료한 챗린지',
...
function ChallengesPanel({ matchLog, scope, playerName, memberNames, session, clubId, t }) {
  ...
  const [optedIn, setOptedIn] = useState(new Set()); // set of `${periodKey}-${challengeId}`
  const [joining, setJoining] = useState('');

  async function loadOptIns() {
    if (!myId) return;
    try {
      let q = supabase.from('challenge_opt_ins').select('challenge_id, period_key').eq('scope', scope);
      q = scope === 'group' ? q.eq('club_id', clubId) : q.is('club_id', null);
      if (scope === 'group') {
        // group challenges are "active" once ANY member opted in — check across all members, not just me
        const { data } = await q;
        setOptedIn(new Set((data || []).map(r => `${r.period_key}-${r.challenge_id}`)));
      } else {
        const { data } = await q.eq('user_id', myId);
        setOptedIn(new Set((data || []).map(r => `${r.period_key}-${r.challenge_id}`)));
      }
    } catch (e) { /* best effort */ }
  }

  useEffect(() => { loadOptIns(); }, [myId, scope, clubId]);

  async function joinChallenge(tpl, periodKey) {
    if (!myId || joining) return;
    setJoining(`${periodKey}-${tpl.id}`);
    try {
      await supabase.from('challenge_opt_ins').insert({
        user_id: myId, scope, club_id: scope === 'group' ? clubId : null, challenge_id: tpl.id, period_key: periodKey,
      });
      setOptedIn(prev => new Set(prev).add(`${periodKey}-${tpl.id}`));
    } catch (e) { /* best effort */ }
    setJoining('');
  }

  function renderRow(tpl, period) {
    const key = `${period.key}-${tpl.id}`;
    const label = fillTemplate(t(tpl.labelKey), { n: tpl.target });
    if (!optedIn.has(key)) {
      return (
        <div key={tpl.id} className="flex items-center gap-2 mb-3 last:mb-0">
          <span className="tt-body text-xs flex-1" style={{ color: C.dim }}>{label}</span>
          <button
            onClick={() => joinChallenge(tpl, period.key)}
            disabled={joining === key}
            className="tt-body text-xs font-semibold px-3 py-1.5 rounded-lg flex-shrink-0 disabled:opacity-50"
            style={{ background: C.greenLight, color: '#04140D' }}
          >
            {t('challenge_play_button')}
          </button>
        </div>
      );
    }
...
function CrossedPaddlesIcon({ size = 19, color = 'currentColor' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeLinecap="round" strokeLinejoin="round">
      <rect x="7.5" y="2.5" width="11" height="13" rx="5" strokeWidth="2" />
      <line x1="9" y1="14" x2="6" y2="19.5" strokeWidth="3.4" />
...
/* ============================= HOME ============================= */
function HomeChallengeBanner({ matchLog, playerName, session, t }) {
  const myId = session && session.user ? session.user.id : null;
  const week = getPeriodBounds('week');
  const month = getPeriodBounds('month');
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const { data } = await supabase.from('challenge_opt_ins').select('challenge_id, period_key').eq('scope', 'personal').is('club_id', null).eq('user_id', myId);
        setOptedIn(new Set((data || []).map(r => `${r.period_key}-${r.challenge_id}`)));
      } catch (e) { /* best effort */ }
    })();
  }, [myId]);

  if (!myId || !playerName) return null;

  const weeklyPicks = pickChallenges(CHALLENGE_TEMPLATES.personal, playerName, week.key, 3);
  const monthlyPicks = pickChallenges(CHALLENGE_TEMPLATES.personal, `${playerName}-m`, month.key, 2);
  const newWeekly = weeklyPicks.find(tpl => !optedIn.has(`${week.key}-${tpl.id}`));
  const newMonthly = monthlyPicks.find(tpl => !optedIn.has(`${month.key}-${tpl.id}`));
  if (!newWeekly && !newMonthly) return null;

  async function join(tpl, periodKey) {
    try {
      await supabase.from('challenge_opt_ins').insert({ user_id: myId, scope: 'personal', club_id: null, challenge_id: tpl.id, period_key: periodKey });
      setOptedIn(prev => new Set(prev).add(`${periodKey}-${tpl.id}`));
    } catch (e) { /* best effort */ }
  }

  function card(tpl, period, titleKey) {
    return (
      <div key={tpl.id} className="rounded-xl p-3 flex items-center gap-3" style={{ background: 'rgba(18,168,118,0.18)', border: `1px solid ${C.greenLight}`, backdropFilter: 'blur(4px)' }}>
        <div className="flex-1 min-w-0">
          <div className="tt-body text-[10px] font-semibold uppercase tracking-wide" style={{ color: C.greenLight }}>{t(titleKey)}</div>
          <div className="tt-body text-sm" style={{ color: '#fff' }}>{fillTemplate(t(tpl.labelKey), { n: tpl.target })}</div>
        </div>
        <button onClick={() => join(tpl, period.key)} className="tt-body text-xs font-semibold px-3 py-1.5 rounded-lg flex-shrink-0" style={{ background: C.greenLight, color: '#04140D' }}>
          {t('challenge_play_button')}
        </button>
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-2 mb-3">
      {newWeekly && card(newWeekly, week, 'challenge_new_weekly')}
      {newMonthly && card(newMonthly, month, 'challenge_new_monthly')}
    </div>
  );
}

function Home({ matchLog, playerName, session }) {
  const { t } = useT();
  ...
  return (
    <div className="relative w-full" style={{ minHeight: '100vh', overflowX: 'hidden', overflowY: 'auto' }}>
      ...
      <div className="absolute left-0 right-0 bottom-0 px-4 pb-4 sm:px-8 sm:pb-8">
        <HomeChallengeBanner matchLog={matchLog} playerName={playerName} session={session} t={t} />
...
function PlayerDetail({ setView, playerName, playerProfileId, matchLog, photos, setPhotos, friends, toggleFriend, onChallenge, profile }) {
  ...
  useEffect(() => {
    if (!playerProfileId) { setPlayerGroups([]); return; }
    (async () => {
      try {
        const { data } = await supabase
          .from('club_members')
          .select('clubs(id, name)')
          .eq('user_id', playerProfileId)
          .eq('status', 'approved');
        setPlayerGroups((data || []).filter(r => r.clubs).map(r => r.clubs));
      } catch (e) { setPlayerGroups([]); }
    })();
  }, [playerProfileId]);

  useEffect(() => {
    if (!playerProfileId || !playerName) { setCompletedChallenges([]); return; }
    (async () => {
      try {
        const week = getPeriodBounds('week');
        const month = getPeriodBounds('month');
        const { data } = await supabase
          .from('challenge_opt_ins')
          .select('challenge_id, period_key')
          .eq('user_id', playerProfileId)
          .eq('scope', 'personal')
          .is('club_id', null)
          .in('period_key', [week.key, month.key]);
        const optedIn = data || [];
        const done = [];
        optedIn.forEach(row => {
          const tpl = CHALLENGE_TEMPLATES.personal.find(c => c.id === row.challenge_id);
          if (!tpl) return;
          const period = row.period_key === week.key ? week : month;
          const { current, target } = tpl.evaluate(matchLog, { playerName, periodStart: period.start });
          if (current >= target) done.push(tpl);
        });
        setCompletedChallenges(done);
      } catch (e) { setCompletedChallenges([]); }
    })();
  }, [playerProfileId, playerName, matchLog]);
  ...
  return (
    <div>
      ...
      {playerGroups.length > 0 && (
        <Panel style={{ marginBottom: 16 }}>
          <div className="tt-body text-sm font-semibold mb-3 flex items-center gap-2" style={{ color: C.dim }}>
            <Building2 size={16} color={C.dim} /> {t('player_groups_title')}
          </div>
          <div className="flex flex-wrap gap-2">
            {playerGroups.map(g => (
              <div key={g.id} className="tt-body text-xs px-3 py-1.5 rounded-full" style={{ background: C.panel2, border: `1px solid ${C.line}`, color: C.text }}>
                {g.name}
              </div>
            ))}
          </div>
      ...
      {completedChallenges.length > 0 && (
        <Panel style={{ marginBottom: 16 }}>
          <div className="tt-body text-sm font-semibold mb-3 flex items-center gap-2" style={{ color: C.dim }}>
            <Target size={16} color={C.dim} /> {t('player_completed_challenges_title')}
          </div>
          <div className="flex flex-col gap-2">
            {completedChallenges.map(tpl => (
              <div key={tpl.id} className="tt-body text-xs flex items-center gap-2" style={{ color: C.text }}>
                <Check size={14} color={C.greenLight} /> {fillTemplate(t(tpl.labelKey), { n: tpl.target })}
              </div>
            ))}
          </div>
        </Panel>
...
function EventHubScreen({ setView, session, onOpenEvent, presetClubId, presetClubName }) {
  ...
  async function loadMyEvents() {
    ...
    try {
      const { data } = await supabase
        ...
        .select('events(id, name, kind, status, club_id)')
        .eq('user_id', myId)
  ...
  useEffect(() => { loadMyEvents(); }, [myId, kind]);
  ...
  return (
    <div>
      ...
      {myEvents.length > 0 && (
        <Panel style={{ marginBottom: 16 }}>
          <div className="tt-body text-sm font-semibold mb-3" style={{ color: C.dim }}>{t('my_events_title')}</div>
          <div className="flex flex-col gap-2">
            {myEvents.map(ev => (
              <button
                key={ev.id}
              ...
              >
                {ev.kind === 'tournament' ? <Trophy size={16} color={C.amber} /> : <Users size={16} color={C.amber} />}
                <div className="tt-body text-sm font-semibold flex-1 min-w-0 truncate" style={{ color: C.text }}>{ev.name}</div>
                <span className="tt-body text-xs flex-shrink-0" style={{ color: C.dim }}>
                  {ev.status === 'open' ? t('event_status_open') : t('event_status_closed')}
                </span>
              </button>
            ))}
          </div>
      ...
      {!presetClubId && (
        <Panel style={{ marginBottom: 16 }}>
          <SegButton options={[{ value: 'create', label: t('event_create_tab_label') }, { value: 'join', label: t('event_join_via_code_title') }]} value={tab} onChange={setTab} />
        </Panel>
      )}
...
function EventLobbyScreen({ setView, eventId, session, onOpenPlay, onKindKnown }) {
  ...
  async function shareCode() {
    if (!event) return;
    const shareUrl = `${window.location.origin}/?join=${event.join_code}`;
    const shareText = groupName
      ? `${groupName}: ${event.name} \u2014 ${t('event_code_label')}: ${event.join_code}`
      : `${event.name} \u2014 ${t('event_code_label')}: ${event.join_code}`;
    if (navigator.share) {
      try { await navigator.share({ title: event.name, text: shareText, url: shareUrl }); } catch (e) { /* user cancelled */ }
    } else {
      try {
  ...
  return (
    <div>
      ...
      <Panel style={{ marginBottom: 16, textAlign: 'center' }}>
        ...
        <div className="tt-body text-xs mt-1 mb-3" style={{ color: C.dim }}>{copied ? '✓' : t('event_share_hint')}</div>
        <GhostButton onClick={shareCode} style={{ width: '100%', textAlign: 'center' }}>
...
function GroupDetailScreen({ setView, groupId, groupName, session, matchLog, onSelectPlayer, onCreateEvent, onOpenEvent }) {
  const { t } = useT();
  const myId = session && session.user ? session.user.id : null;
  ...
  return (
    <div>
      ...
      {groupEvents.length > 0 && (
        <Panel style={{ marginBottom: 16 }}>
          <div className="tt-body text-sm font-semibold mb-3" style={{ color: C.dim }}>{t('group_events_title')}</div>
          <div className="flex flex-col gap-2">
            {groupEvents.map(ev => (
              <button
                key={ev.id}
      ...
      {members.length > 0 && (
        <div style={{ marginBottom: 16 }}>
          <ChallengesPanel matchLog={matchLog} scope="group" memberNames={members.map(m => m.username)} session={session} clubId={groupId} t={t} />
        </div>
      )}
...
function MyProfile({ setView, matchLog, session, profile, setProfile }) {
  ...
  const [confirmingGuestLogout, setConfirmingGuestLogout] = useState(false);

  useEffect(() => {
    if (!confirmingGuestLogout) return;
    const timer = setTimeout(() => setConfirmingGuestLogout(false), 5000);
    return () => clearTimeout(timer);
  }, [confirmingGuestLogout]);

  async function handleGuestLogoutClick() {
    if (!confirmingGuestLogout) { setConfirmingGuestLogout(true); return; }
    setConfirmingGuestLogout(false);
    setDeletingAccount(true);
    try {
      await supabase.from('profiles').delete().eq('id', userId);
    } catch (e) { /* best effort */ }
    ...
    <div>
      ...
      {isGuest && profile && profile.has_paid ? (
        <Panel style={{ marginTop: 16, borderColor: C.amber }}>
          <div className="tt-body text-xs" style={{ color: C.text }}>{t('profile_guest_locked_notice')}</div>
        </Panel>
      ) : isGuest ? (
        <Panel style={{ marginTop: 16, borderColor: C.amber }}>
          <div className="tt-body text-xs mb-3" style={{ color: C.dim }}>{t('profile_guest_logout_warning')}</div>
          <button
            onClick={handleGuestLogoutClick}
            disabled={deletingAccount}
            className="tt-body w-full px-4 py-2.5 rounded-xl font-semibold transition-colors disabled:opacity-50"
            style={{
              background: confirmingGuestLogout ? C.red : 'transparent',
              color: confirmingGuestLogout ? '#fff' : C.red,
              border: `1px solid ${C.red}`,
            }}
          >
            {confirmingGuestLogout ? t('settings_delete_account_confirm') : t('settings_logout')}
          </button>
        </Panel>
      ) : (
...
export default function App() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const { data: ev } = await supabase.from('events').select('id, status').eq('join_code', code.toUpperCase()).maybeSingle();
        if (!ev) return;
        if (ev.status === 'open') {
          try { await supabase.from('event_participants').insert({ event_id: ev.id, user_id: uid, status: 'registered' }); }
          catch (e) { /* already joined, ignore */ }
        }
  ...
  else if (view === 'group-detail') content = <GroupDetailScreen setView={setView} groupId={selectedGroupId} groupName={selectedGroupName} session={session} matchLog={combinedMatchLog} onSelectPlayer={selectPlayer} onCreateEvent={openEventCreateForGroup} onOpenEvent={openEvent} />;
